...
export default function PricingPage() {
  ...
  useEffect(() => {
    ...
    }, 300); // each card appears after 300ms
  ...
  return (
    <main className="bg-gray-50 min-h-screen py-16 px-6">
      ...
      {/* FAQ Section */}
      <div className="section gray max-w-4xl mx-auto">
        ...
        <div className="faq-wrapper space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="faq-item bg-white rounded-xl shadow-md p-4 cursor-pointer transition-all duration-300 ease-in-out"
              onClick={() => toggleFAQ(index)}
            >
              <div className="flex items-center justify-between">
                <div className="faq-title font-semibold text-gray-800">
                  {faq.question}
                </div>
                <img
