...
import { FaFacebookF, FaInstagram, FaSearch, FaEnvelope, FaPhoneAlt } from "react-icons/fa";
    ...
    <header className="sticky top-0 z-50 bg-blue-500 text-white shadow-md">
      ...
      <div className="container mx-auto flex items-center justify-between px-4 md:px-6 h-16">
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          {/* Rounded square hamburger like screenshot */}
          <button
      ...
      {/* MOBILE SEARCH SHEET (under the blue bar) */}
      <div
      ...
      {/* MOBILE MENU SHEET (light panel like screenshot) */}
      <nav
      ...
      >
        <div className="px-6 py-5 space-y-5">
          <Link href="/" className="block text-base tracking-wide" onClick={() => setMenuOpen(false)}>HOME</Link>
          <Link href="/about" className="block text-base tracking-wide" onClick={() => setMenuOpen(false)}>ABOUT</Link>
          <Link href="/blog" className="block text-base tracking-wide" onClick={() => setMenuOpen(false)}>BLOG</Link>
          <Link href="/contact" className="block text-base tracking-wide" onClick={() => setMenuOpen(false)}>CONTACT</Link>
          <Link href="/pricing" className="block text-base tracking-wide" onClick={() => setMenuOpen(false)}>PRICING</Link>
