      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 h-16 relative">
        ...
        <nav className="hidden lg:flex items-center gap-6">
          ...
          <div className="hidden xl:flex items-center gap-4">
            <Link href="https://facebook.com/quicksquads" target="_blank">
              <FaFacebookF />
            </Link>
            <Link href="https://instagram.com/quicksquad_tech" target="_blank">
              <FaInstagram />
            </Link>
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          >
            <div className="space-y-1.5">
              ...
              />
              <span
                className={`block w-6 h-0.5 bg-white transition ${menuOpen ? "opacity-0" : ""}`}
              />
              <span
                className={`block w-6 h-0.5 bg-white transition ${menuOpen ? "-translate-y-2 -rotate-45" : ""}`}
              />
